...
<head>
    <title>Code coverage report for src/server/service.mock.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/server</a> service.mock.js</h1>
        <div class='clearfix'>
...
<a name='L78'></a><a href='#L78'>78</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const ServerError = require('./utils/server.error.js');
...
&nbsp;
module.exports.expandById = <span class="fstat-no" title="function not covered" >as</span>ync (_args, _context) =&gt; {
  let message = <span class="cstat-no" title="statement not covered" >"Calling mock service. Did you forget to implement 'expandById'.";</span>
<span class="cstat-no" title="statement not covered" >  logger.info(message);</span>
<span class="cstat-no" title="statement not covered" >  throw new ServerError(message, errorDetails(message));</span>
};
&nbsp;</pre></td></tr></table></pre>
