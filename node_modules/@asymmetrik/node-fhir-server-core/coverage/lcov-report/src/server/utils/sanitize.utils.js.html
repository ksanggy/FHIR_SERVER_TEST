...
<head>
    <title>Code coverage report for src/server/utils/sanitize.utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/utils</a> sanitize.utils.js</h1>
        <div class='clearfix'>
...
<a name='L153'></a><a href='#L153'>153</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const sanitize = require('sanitize-html');
...
let parseValue = function (type, value) {
  ...
  switch (type) {
    ...
    case 'token':
      ...
      result = validator.stripLow(xss(sanitize(value)));
      break;
<span class="branch-7 cbranch-no" title="branch not covered" >    case 'json_string':</span>
<span class="cstat-no" title="statement not covered" >      result = JSON.parse(value);</span>
...
let validateType = function (type, value) {
  ...
  switch (type) {
    ...
    case 'date':
      ...
      break;
<span class="branch-7 cbranch-no" title="branch not covered" >    case 'json_string':</span>
<span class="cstat-no" title="statement not covered" >      result = typeof value === 'object';</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    default:
      result = false;
      break;
...
let parseParams = (req) =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (req.params &amp;&amp; Object.keys(req.params).length) {
    Object.assign(params, req.params);
  }
  return params;
};
&nbsp;
let findMatchWithName = (name = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span> params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
