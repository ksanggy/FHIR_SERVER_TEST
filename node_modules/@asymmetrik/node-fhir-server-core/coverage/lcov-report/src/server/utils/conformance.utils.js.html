...
<head>
    <title>Code coverage report for src/server/utils/conformance.utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/utils</a> conformance.utils.js</h1>
        <div class='clearfix'>
...
<a name='L98'></a><a href='#L98'>98</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { getSearchParameters } = require('./params.utils');
&nbsp;
// /**
...
<span class="branch-0 cbranch-no" title="branch not covered" >      false</span>
...
let conformanceSearchParamsMap = <span class="fstat-no" title="function not covered" >(v</span>ersion) =&gt; <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(r</span>oute_arg) =&gt; {</span>
...
&nbsp;
    // don't show version
    <span class="missing-if-branch" title="else path not taken" >E</span>if (param.versions) {
