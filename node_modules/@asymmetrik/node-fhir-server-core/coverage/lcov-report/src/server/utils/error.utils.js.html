...
<head>
    <title>Code coverage report for src/server/utils/error.utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/utils</a> error.utils.js</h1>
        <div class='clearfix'>
...
<a name='L198'></a><a href='#L198'>198</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">9x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { ISSUE, VERSIONS } = require('../../constants');
...
&nbsp;
let methodNotAllowed = <span class="fstat-no" title="function not covered" >(m</span>essage, base_version) =&gt; {
  let ErrorConstructor = <span class="cstat-no" title="statement not covered" >getErrorConstructor(base_version);</span>
<span class="cstat-no" title="statement not covered" >  return new ErrorConstructor({</span>
    statusCode: 405,
    text: {
      status: 'generated',
...
&nbsp;
let deleteConflict = <span class="fstat-no" title="function not covered" >(m</span>essage, base_version) =&gt; {
  let ErrorConstructor = <span class="cstat-no" title="statement not covered" >getErrorConstructor(base_version);</span>
<span class="cstat-no" title="statement not covered" >  return new ErrorConstructor({</span>
    statusCode: 409,
    text: {
