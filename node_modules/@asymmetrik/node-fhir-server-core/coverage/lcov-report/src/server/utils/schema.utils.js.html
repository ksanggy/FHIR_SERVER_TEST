...
<head>
    <title>Code coverage report for src/server/utils/schema.utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/utils</a> schema.utils.js</h1>
        <div class='clearfix'>
...
<a name='L37'></a><a href='#L37'>37</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
 ...
 * @param {String} schema
 */
const resolveSchema = (version = '4_0_0', schema = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> =&gt; {
