...
<head>
    <title>Code coverage report for src/server/winston.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/server</a> winston.js</h1>
        <div class='clearfix'>
...
<a name='L62'></a><a href='#L62'>62</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { Container, transports } = require('winston');
&nbsp;
/**
 * Features
 ...
 */
const get = (name = <span class="branch-0 cbranch-no" title="branch not covered" >'default',</span> options) =&gt; container.get(name, options);
&nbsp;
/**
 * @function initialize
 * @description Initialize a default console logger
 */
const initialize = (config = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (container.has('default')) {
...
<span class="cstat-no" title="statement not covered" >    container.add('default', {</span>
