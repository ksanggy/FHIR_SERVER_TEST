...
<head>
    <title>Code coverage report for src/server/middleware/sof-scope.middleware.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/middleware</a> sof-scope.middleware.js</h1>
        <div class='clearfix'>
...
<a name='L83'></a><a href='#L83'>83</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const scopeChecker = require('@asymmetrik/sof-scope-checker');
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(scopes)) {
<span class="cstat-no" title="statement not covered" >    return scopes;</span>
  }
&nbsp;
