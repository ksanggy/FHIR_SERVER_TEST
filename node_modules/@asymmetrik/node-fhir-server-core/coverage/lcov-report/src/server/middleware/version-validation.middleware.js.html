...
<head>
    <title>Code coverage report for src/server/middleware/version-validation.middleware.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/server/middleware</a> version-validation.middleware.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">734x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">734x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const errors = require('../utils/error.utils');
&nbsp;
/**
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (baseUrls.length) {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(r</span>eq, res, next) =&gt; {</span>
      const base_version = <span class="cstat-no" title="statement not covered" >req.params &amp;&amp; req.params.base_version;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (baseUrls.indexOf(`/${base_version}`) === -1) {</span>
<span class="cstat-no" title="statement not covered" >        return next(errors.notFound(undefined, base_version));</span>
      }
&nbsp;
