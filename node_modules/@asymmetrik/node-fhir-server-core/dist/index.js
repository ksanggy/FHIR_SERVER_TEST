const {
  resolveSchema
} = require('./server/utils/schema.utils');
...
module.exports = {
   ...
   * @return {Server}
   */
  initialize: (config, app) => new Server(config, app).configureMiddleware().configureSession().configureHelmet().configurePassport().setPublicDirectory().setProfileRoutes().setErrorRoutes()
};