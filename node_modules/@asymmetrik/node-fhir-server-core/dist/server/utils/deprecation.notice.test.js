...
describe('Deprecation Notice', () => {
  test('should log a deprecation notice when the given function is used', () => {
    ...
    let test = jest.fn();
    let message = 'Deprecated'; // mark our function as deprecated

    let func = deprecationNotice(test, message); // Call our deprecated function
  ...
  test('should log a deprecation notice when any function on a given object(not recursive) is used', () => {
    ...
    let newTest = deprecationNotice(test, message); // Call our deprecated functions
  ...
  test('should not replace original object, return a clone with wrapped functions', () => {
    ...
    expect(newTest.obj).toBe(test.obj); // Calling the new version should invoke the spy, while calling the original
  ...
  test('should pass all arguments through to deprecated function in same order', () => {
    ...
    let func = deprecationNotice(test, message); // Call our deprecated function with a mock parameter
