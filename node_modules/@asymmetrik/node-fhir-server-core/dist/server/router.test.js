...
describe('Router Tests', () => {
  ...
  test('should enable metadata routes for all versions configured', () => {
    ...
    expect(app.get.mock.calls[0]).toHaveLength(5); // Check the verison validation middleware, we mocked it above
  ...
  test('should throw for invalid profile configurations', () => {
    ...
    let profileWiki = 'https://github.com/Asymmetrik/node-fhir-server-core/wiki/Profile'; // test an invalid version
    ...
    }).toThrowError(profileWiki); // test an invalid profile
  ...
  test('should throw for invalid operation configurations', () => {
    ...
    let operationWiki = 'https://github.com/Asymmetrik/node-fhir-server-core/wiki/Operations'; // Should throw for missing name, route, method, or a matching controller
    // Name throws first
    ...
    }).toThrowError(operationWiki); // missing route throws next
    ...
    }).toThrowError(operationWiki); // missing operation is next
    ...
    }).toThrowError(operationWiki); // No matching service module is last
