...
module.exports = class Patient {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'careProvider', {
      enumerable: true,
      get: () => this.__data.careProvider,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data.careProvider = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    });
  ...
  toJSON() {
    return {
      ...
      careProvider: this.careProvider && this.careProvider.map(v => v.toJSON()),
