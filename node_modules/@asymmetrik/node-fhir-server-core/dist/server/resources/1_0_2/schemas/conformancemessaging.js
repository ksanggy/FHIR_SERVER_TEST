  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'endpoint', {
      ...
      set: value => {
        ...
        this.__data.endpoint = Array.isArray(value) ? value.map(v => new ConformanceMessagingEndpoint(v)) : [new ConformanceMessagingEndpoint(value)];
      }
    });
    ...
    Object.defineProperty(this, 'event', {
      ...
      set: value => {
        ...
        this.__data.event = Array.isArray(value) ? value.map(v => new ConformanceMessagingEvent(v)) : [new ConformanceMessagingEvent(value)];
      }
