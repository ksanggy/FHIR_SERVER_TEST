  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ClaimResponseItemDetailSubDetailAdjudication(v)) : [new ClaimResponseItemDetailSubDetailAdjudication(value)];
      }
