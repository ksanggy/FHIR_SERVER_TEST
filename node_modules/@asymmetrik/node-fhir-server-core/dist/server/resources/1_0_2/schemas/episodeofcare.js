  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'condition', {
      ...
      set: value => {
        ...
        this.__data.condition = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    });
    ...
    Object.defineProperty(this, 'careTeam', {
      ...
      set: value => {
        ...
        let EpisodeOfCareCareTeam = require('./episodeofcarecareteam.js');

        this.__data.careTeam = Array.isArray(value) ? value.map(v => new EpisodeOfCareCareTeam(v)) : [new EpisodeOfCareCareTeam(value)];
      }
