...
module.exports = class TestScript {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contact', {
      ...
      set: value => {
        ...
        let TestScriptContact = require('./testscriptcontact.js');

        this.__data.contact = Array.isArray(value) ? value.map(v => new TestScriptContact(v)) : [new TestScriptContact(value)];
      }
    });
    ...
    Object.defineProperty(this, '_multiserver', {
      enumerable: true,
      get: () => this.__data._multiserver,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._multiserver = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      _multiserver: this._multiserver && this._multiserver.toJSON(),
