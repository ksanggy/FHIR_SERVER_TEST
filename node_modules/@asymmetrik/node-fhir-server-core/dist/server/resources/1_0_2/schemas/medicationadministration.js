  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'reasonNotGiven', {
      ...
      set: value => {
        ...
        this.__data.reasonNotGiven = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    ...
    Object.defineProperty(this, 'reasonGiven', {
      ...
      set: value => {
        ...
        this.__data.reasonGiven = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
