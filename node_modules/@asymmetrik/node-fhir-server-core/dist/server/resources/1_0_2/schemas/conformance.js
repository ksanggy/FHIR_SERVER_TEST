  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contact', {
      ...
      set: value => {
        ...
        this.__data.contact = Array.isArray(value) ? value.map(v => new ConformanceContact(v)) : [new ConformanceContact(value)];
      }
    });
    ...
    Object.defineProperty(this, 'messaging', {
      ...
      set: value => {
        ...
        this.__data.messaging = Array.isArray(value) ? value.map(v => new ConformanceMessaging(v)) : [new ConformanceMessaging(value)];
      }
    });
    Object.defineProperty(this, 'document', {
      ...
      set: value => {
        ...
        this.__data.document = Array.isArray(value) ? value.map(v => new ConformanceDocument(v)) : [new ConformanceDocument(value)];
      }
