  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ClaimResponseAddItemDetailAdjudication(v)) : [new ClaimResponseAddItemDetailAdjudication(value)];
      }
