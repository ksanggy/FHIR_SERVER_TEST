/**
 * @name exports
 * @summary DeviceUseRequest Class
 */
module.exports = class DeviceUseRequest {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'indication', {
      ...
      set: value => {
        ...
        this.__data.indication = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
    ...
    Object.defineProperty(this, 'prnReason', {
      ...
      set: value => {
        ...
        this.__data.prnReason = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
