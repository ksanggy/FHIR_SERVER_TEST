  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'relatedPlan', {
      ...
      set: value => {
        ...
        this.__data.relatedPlan = Array.isArray(value) ? value.map(v => new CarePlanRelatedPlan(v)) : [new CarePlanRelatedPlan(value)];
      }
    });
    Object.defineProperty(this, 'participant', {
      ...
      set: value => {
        ...
        this.__data.participant = Array.isArray(value) ? value.map(v => new CarePlanParticipant(v)) : [new CarePlanParticipant(value)];
      }
    });
    ...
    Object.defineProperty(this, 'activity', {
      ...
      set: value => {
        ...
        this.__data.activity = Array.isArray(value) ? value.map(v => new CarePlanActivity(v)) : [new CarePlanActivity(value)];
      }
    });
