  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'event', {
      ...
      set: value => {
        ...
        this.__data.event = Array.isArray(value) ? value.map(v => new DiagnosticOrderEvent(v)) : [new DiagnosticOrderEvent(value)];
      }
    });
    Object.defineProperty(this, 'item', {
      ...
      set: value => {
        ...
        this.__data.item = Array.isArray(value) ? value.map(v => new DiagnosticOrderItem(v)) : [new DiagnosticOrderItem(value)];
      }
    });
