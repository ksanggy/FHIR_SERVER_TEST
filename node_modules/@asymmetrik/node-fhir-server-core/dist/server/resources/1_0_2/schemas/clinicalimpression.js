  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'investigations', {
      ...
      set: value => {
        ...
        this.__data.investigations = Array.isArray(value) ? value.map(v => new ClinicalImpressionInvestigations(v)) : [new ClinicalImpressionInvestigations(value)];
      }
    });
    ...
    Object.defineProperty(this, 'resolved', {
      ...
      set: value => {
        ...
        this.__data.resolved = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
    Object.defineProperty(this, 'ruledOut', {
      ...
      set: value => {
        ...
        this.__data.ruledOut = Array.isArray(value) ? value.map(v => new ClinicalImpressionRuledOut(v)) : [new ClinicalImpressionRuledOut(value)];
      }
    });
