  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contact', {
      ...
      set: value => {
        ...
        this.__data.contact = Array.isArray(value) ? value.map(v => new ImplementationGuideContact(v)) : [new ImplementationGuideContact(value)];
      }
    });
    ...
    Object.defineProperty(this, 'useContext', {
      ...
      set: value => {
        ...
        this.__data.useContext = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
    ...
    Object.defineProperty(this, 'dependency', {
      ...
      set: value => {
        ...
        this.__data.dependency = Array.isArray(value) ? value.map(v => new ImplementationGuideDependency(v)) : [new ImplementationGuideDependency(value)];
      }
    });
    Object.defineProperty(this, 'package', {
      ...
      set: value => {
        ...
        this.__data.package = Array.isArray(value) ? value.map(v => new ImplementationGuidePackage(v)) : [new ImplementationGuidePackage(value)];
      }
    });
