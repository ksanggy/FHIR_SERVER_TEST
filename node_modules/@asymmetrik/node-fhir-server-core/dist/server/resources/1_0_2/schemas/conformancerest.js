  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'resource', {
      ...
      set: value => {
        ...
        this.__data.resource = Array.isArray(value) ? value.map(v => new ConformanceRestResource(v)) : [new ConformanceRestResource(value)];
      }
    });
    Object.defineProperty(this, 'interaction', {
      ...
      set: value => {
        ...
        this.__data.interaction = Array.isArray(value) ? value.map(v => new ConformanceRestInteraction(v)) : [new ConformanceRestInteraction(value)];
      }
    });
    ...
    Object.defineProperty(this, 'operation', {
      ...
      set: value => {
        ...
        this.__data.operation = Array.isArray(value) ? value.map(v => new ConformanceRestOperation(v)) : [new ConformanceRestOperation(value)];
      }
    });
