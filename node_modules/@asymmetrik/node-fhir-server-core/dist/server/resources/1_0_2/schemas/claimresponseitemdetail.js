  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        let ClaimResponseItemDetailAdjudication = require('./claimresponseitemdetailadjudication.js');

        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ClaimResponseItemDetailAdjudication(v)) : [new ClaimResponseItemDetailAdjudication(value)];
      }
    });
    Object.defineProperty(this, 'subDetail', {
      ...
      set: value => {
        ...
        this.__data.subDetail = Array.isArray(value) ? value.map(v => new ClaimResponseItemDetailSubDetail(v)) : [new ClaimResponseItemDetailSubDetail(value)];
      }
