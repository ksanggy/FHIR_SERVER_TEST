  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'frames', {
      ...
      set: value => {
        ...
        this.__data.frames = Array.isArray(value) ? value.map(v => new ImagingObjectSelectionStudySeriesInstanceFrames(v)) : [new ImagingObjectSelectionStudySeriesInstanceFrames(value)];
      }
