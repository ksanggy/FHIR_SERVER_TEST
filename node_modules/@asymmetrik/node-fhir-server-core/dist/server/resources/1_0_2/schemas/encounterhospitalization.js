  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'admittingDiagnosis', {
      ...
      set: value => {
        ...
        this.__data.admittingDiagnosis = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    });
    ...
    Object.defineProperty(this, 'dischargeDiagnosis', {
      ...
      set: value => {
        ...
        this.__data.dischargeDiagnosis = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
