...
module.exports = class Practitioner {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'practitionerRole', {
      enumerable: true,
      get: () => this.__data.practitionerRole,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }

        let PractitionerPractitionerRole = require('./practitionerpractitionerrole.js');

        this.__data.practitionerRole = Array.isArray(value) ? value.map(v => new PractitionerPractitionerRole(v)) : [new PractitionerPractitionerRole(value)];
      }
    });
    Object.defineProperty(this, 'qualification', {
      ...
      set: value => {
        ...
        let PractitionerQualification = require('./practitionerqualification.js');

        this.__data.qualification = Array.isArray(value) ? value.map(v => new PractitionerQualification(v)) : [new PractitionerQualification(value)];
      }
    });
  ...
  toJSON() {
    return {
      ...
      practitionerRole: this.practitionerRole && this.practitionerRole.map(v => v.toJSON()),
