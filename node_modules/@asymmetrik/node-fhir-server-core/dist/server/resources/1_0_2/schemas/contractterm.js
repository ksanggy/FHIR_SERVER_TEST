  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'actionReason', {
      ...
      set: value => {
        ...
        this.__data.actionReason = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
    Object.defineProperty(this, 'actor', {
      ...
      set: value => {
        ...
        let ContractTermActor = require('./contracttermactor.js');

        this.__data.actor = Array.isArray(value) ? value.map(v => new ContractTermActor(v)) : [new ContractTermActor(value)];
      }
    });
    ...
    Object.defineProperty(this, 'valuedItem', {
      ...
      set: value => {
        ...
        this.__data.valuedItem = Array.isArray(value) ? value.map(v => new ContractTermValuedItem(v)) : [new ContractTermValuedItem(value)];
      }
