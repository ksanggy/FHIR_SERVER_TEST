  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'ingredient', {
      ...
      set: value => {
        ...
        this.__data.ingredient = Array.isArray(value) ? value.map(v => new MedicationProductIngredient(v)) : [new MedicationProductIngredient(value)];
      }
    });
    Object.defineProperty(this, 'batch', {
      ...
      set: value => {
        ...
        this.__data.batch = Array.isArray(value) ? value.map(v => new MedicationProductBatch(v)) : [new MedicationProductBatch(value)];
      }
