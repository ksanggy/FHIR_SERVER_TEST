  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'administration', {
      ...
      set: value => {
        ...
        this.__data.administration = Array.isArray(value) ? value.map(v => new NutritionOrderEnteralFormulaAdministration(v)) : [new NutritionOrderEnteralFormulaAdministration(value)];
      }
    });
