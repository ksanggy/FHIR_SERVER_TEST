  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'treatment', {
      ...
      set: value => {
        ...
        let SpecimenTreatment = require('./specimentreatment.js');

        this.__data.treatment = Array.isArray(value) ? value.map(v => new SpecimenTreatment(v)) : [new SpecimenTreatment(value)];
      }
    });
