  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ClaimResponseAddItemAdjudication(v)) : [new ClaimResponseAddItemAdjudication(value)];
      }
    });
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        this.__data.detail = Array.isArray(value) ? value.map(v => new ClaimResponseAddItemDetail(v)) : [new ClaimResponseAddItemDetail(value)];
      }
