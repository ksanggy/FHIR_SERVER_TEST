  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'note', {
      ...
      set: value => {
        ...
        this.__data.note = Array.isArray(value) ? value.map(v => new ClaimResponseNote(v)) : [new ClaimResponseNote(value)];
      }
    });
    Object.defineProperty(this, 'coverage', {
      ...
      set: value => {
        ...
        this.__data.coverage = Array.isArray(value) ? value.map(v => new ClaimResponseCoverage(v)) : [new ClaimResponseCoverage(value)];
      }
