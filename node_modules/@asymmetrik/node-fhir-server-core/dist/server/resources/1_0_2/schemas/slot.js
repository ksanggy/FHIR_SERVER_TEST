...
module.exports = class Slot {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_freeBusyType', {
      enumerable: true,
      get: () => this.__data._freeBusyType,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._freeBusyType = new Element(value);
      }
    }); // valueSetReference: http://hl7.org/fhir/ValueSet/slotstatus

    Object.defineProperty(this, 'freeBusyType', {
      enumerable: true,
      get: () => this.__data.freeBusyType,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }

        this.__data.freeBusyType = value;
      }
    });
  ...
  toJSON() {
    return {
      ...
      _freeBusyType: this._freeBusyType && this._freeBusyType.toJSON(),
      freeBusyType: this.freeBusyType,
