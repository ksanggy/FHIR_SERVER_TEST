  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'reasonNotTaken', {
      ...
      set: value => {
        ...
        this.__data.reasonNotTaken = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    ...
    Object.defineProperty(this, 'dosage', {
      ...
      set: value => {
        ...
        this.__data.dosage = Array.isArray(value) ? value.map(v => new MedicationStatementDosage(v)) : [new MedicationStatementDosage(value)];
      }
