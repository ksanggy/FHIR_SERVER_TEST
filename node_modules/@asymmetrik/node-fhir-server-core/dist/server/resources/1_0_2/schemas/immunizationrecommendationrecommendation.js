  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'dateCriterion', {
      ...
      set: value => {
        ...
        this.__data.dateCriterion = Array.isArray(value) ? value.map(v => new ImmunizationRecommendationRecommendationDateCriterion(v)) : [new ImmunizationRecommendationRecommendationDateCriterion(value)];
      }
    });
