  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contact', {
      ...
      set: value => {
        ...
        let NamingSystemContact = require('./namingsystemcontact.js');

        this.__data.contact = Array.isArray(value) ? value.map(v => new NamingSystemContact(v)) : [new NamingSystemContact(value)];
      }
    });
    ...
    Object.defineProperty(this, 'uniqueId', {
      ...
      set: value => {
        ...
        this.__data.uniqueId = Array.isArray(value) ? value.map(v => new NamingSystemUniqueId(v)) : [new NamingSystemUniqueId(value)];
      }
    });
