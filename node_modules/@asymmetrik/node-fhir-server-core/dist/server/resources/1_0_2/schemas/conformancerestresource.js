  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'interaction', {
      ...
      set: value => {
        ...
        this.__data.interaction = Array.isArray(value) ? value.map(v => new ConformanceRestResourceInteraction(v)) : [new ConformanceRestResourceInteraction(value)];
      }
    });
    ...
    Object.defineProperty(this, 'searchParam', {
      ...
      set: value => {
        ...
        this.__data.searchParam = Array.isArray(value) ? value.map(v => new ConformanceRestResourceSearchParam(v)) : [new ConformanceRestResourceSearchParam(value)];
      }
