/**
 * @name exports
 * @summary ServiceDefinition Class
 */
module.exports = class ServiceDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'operationDefinition', {
      enumerable: true,
      get: () => this.__data.operationDefinition,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data.operationDefinition = new Reference(value);
      }
  ...
  toJSON() {
    return {
      ...
      operationDefinition: this.operationDefinition && this.operationDefinition.toJSON()
    };
  }
