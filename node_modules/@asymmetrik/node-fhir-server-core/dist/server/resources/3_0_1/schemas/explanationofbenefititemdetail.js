/**
 * @name exports
 * @summary ExplanationOfBenefitItemDetail Class
 */
module.exports = class ExplanationOfBenefitItemDetail {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitItemAdjudication(v)) : [new ExplanationOfBenefitItemAdjudication(value)];
      }
    });
    Object.defineProperty(this, 'subDetail', {
      ...
      set: value => {
        ...
        let ExplanationOfBenefitItemDetailSubDetail = require('./explanationofbenefititemdetailsubdetail.js');

        this.__data.subDetail = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitItemDetailSubDetail(v)) : [new ExplanationOfBenefitItemDetailSubDetail(value)];
      }
    ...
    Object.defineProperty(this, 'resourceType', {
      value: 'ExplanationOfBenefitItemDetail',
      enumerable: true,
      writable: false
    });
  }
