  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'endpoint', {
      ...
      set: value => {
        ...
        this.__data.endpoint = Array.isArray(value) ? value.map(v => new CapabilityStatementMessagingEndpoint(v)) : [new CapabilityStatementMessagingEndpoint(value)];
      }
    });
    ...
    Object.defineProperty(this, 'supportedMessage', {
      ...
      set: value => {
        ...
        this.__data.supportedMessage = Array.isArray(value) ? value.map(v => new CapabilityStatementMessagingSupportedMessage(v)) : [new CapabilityStatementMessagingSupportedMessage(value)];
      }
    });
    Object.defineProperty(this, 'event', {
      ...
      set: value => {
        ...
        let CapabilityStatementMessagingEvent = require('./capabilitystatementmessagingevent.js');

        this.__data.event = Array.isArray(value) ? value.map(v => new CapabilityStatementMessagingEvent(v)) : [new CapabilityStatementMessagingEvent(value)];
      }
