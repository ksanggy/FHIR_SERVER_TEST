  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'population', {
      ...
      set: value => {
        ...
        this.__data.population = Array.isArray(value) ? value.map(v => new MeasureGroupPopulation(v)) : [new MeasureGroupPopulation(value)];
      }
    });
    Object.defineProperty(this, 'stratifier', {
      ...
      set: value => {
        ...
        this.__data.stratifier = Array.isArray(value) ? value.map(v => new MeasureGroupStratifier(v)) : [new MeasureGroupStratifier(value)];
      }
