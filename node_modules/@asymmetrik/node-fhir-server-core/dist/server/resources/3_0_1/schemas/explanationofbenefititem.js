/**
 * @name exports
 * @summary ExplanationOfBenefitItem Class
 */
module.exports = class ExplanationOfBenefitItem {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        let ExplanationOfBenefitItemDetail = require('./explanationofbenefititemdetail.js');

        this.__data.detail = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitItemDetail(v)) : [new ExplanationOfBenefitItemDetail(value)];
      }
