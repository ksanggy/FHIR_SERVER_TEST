  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'triggerDefinition', {
      ...
      set: value => {
        ...
        this.__data.triggerDefinition = Array.isArray(value) ? value.map(v => new TriggerDefinition(v)) : [new TriggerDefinition(value)];
      }
    });
    Object.defineProperty(this, 'condition', {
      ...
      set: value => {
        ...
        this.__data.condition = Array.isArray(value) ? value.map(v => new PlanDefinitionActionCondition(v)) : [new PlanDefinitionActionCondition(value)];
      }
    });
    ...
    Object.defineProperty(this, 'relatedAction', {
      ...
      set: value => {
        ...
        this.__data.relatedAction = Array.isArray(value) ? value.map(v => new PlanDefinitionActionRelatedAction(v)) : [new PlanDefinitionActionRelatedAction(value)];
      }
    });
    ...
    Object.defineProperty(this, 'participant', {
      ...
      set: value => {
        ...
        this.__data.participant = Array.isArray(value) ? value.map(v => new PlanDefinitionActionParticipant(v)) : [new PlanDefinitionActionParticipant(value)];
      }
    ...
    Object.defineProperty(this, 'dynamicValue', {
      ...
      set: value => {
        ...
        this.__data.dynamicValue = Array.isArray(value) ? value.map(v => new PlanDefinitionActionDynamicValue(v)) : [new PlanDefinitionActionDynamicValue(value)];
      }
    });
