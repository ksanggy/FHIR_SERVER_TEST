  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'insurance', {
      ...
      set: value => {
        ...
        this.__data.insurance = Array.isArray(value) ? value.map(v => new EligibilityResponseInsurance(v)) : [new EligibilityResponseInsurance(value)];
      }
    ...
    Object.defineProperty(this, 'error', {
      ...
      set: value => {
        ...
        this.__data.error = Array.isArray(value) ? value.map(v => new EligibilityResponseError(v)) : [new EligibilityResponseError(value)];
      }
