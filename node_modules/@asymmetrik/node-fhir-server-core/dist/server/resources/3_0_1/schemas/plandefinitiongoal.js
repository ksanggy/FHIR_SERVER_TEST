/**
 * @name exports
 * @summary PlanDefinitionGoal Class
 */
module.exports = class PlanDefinitionGoal {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'target', {
      ...
      set: value => {
        ...
        let PlanDefinitionGoalTarget = require('./plandefinitiongoaltarget.js');

        this.__data.target = Array.isArray(value) ? value.map(v => new PlanDefinitionGoalTarget(v)) : [new PlanDefinitionGoalTarget(value)];
      }
