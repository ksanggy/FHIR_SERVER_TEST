/**
 * @name exports
 * @summary ExplanationOfBenefitAddItem Class
 */
module.exports = class ExplanationOfBenefitAddItem {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        let ExplanationOfBenefitAddItemDetail = require('./explanationofbenefitadditemdetail.js');

        this.__data.detail = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitAddItemDetail(v)) : [new ExplanationOfBenefitAddItemDetail(value)];
      }
