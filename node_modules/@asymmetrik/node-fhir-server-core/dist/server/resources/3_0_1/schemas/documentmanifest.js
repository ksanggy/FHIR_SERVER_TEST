  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'content', {
      ...
      set: value => {
        ...
        let DocumentManifestContent = require('./documentmanifestcontent.js');

        this.__data.content = Array.isArray(value) ? value.map(v => new DocumentManifestContent(v)) : [new DocumentManifestContent(value)];
      }
    });
    Object.defineProperty(this, 'related', {
      ...
      set: value => {
        ...
        this.__data.related = Array.isArray(value) ? value.map(v => new DocumentManifestRelated(v)) : [new DocumentManifestRelated(value)];
      }
