...
module.exports = class MedicationDispense {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'performer', {
      ...
      set: value => {
        ...
        this.__data.performer = Array.isArray(value) ? value.map(v => new MedicationDispensePerformer(v)) : [new MedicationDispensePerformer(value)];
      }
    });
    Object.defineProperty(this, 'authorizingPrescription', {
      ...
      set: value => {
        ...
        this.__data.authorizingPrescription = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    ...
    Object.defineProperty(this, 'notDoneReasonCodeableConcept', {
      enumerable: true,
      get: () => this.__data.notDoneReasonCodeableConcept,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data.notDoneReasonCodeableConcept = new CodeableConcept(value);
      }
    });
    Object.defineProperty(this, 'notDoneReasonReference', {
      enumerable: true,
      get: () => this.__data.notDoneReasonReference,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data.notDoneReasonReference = new Reference(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      notDoneReasonCodeableConcept: this.notDoneReasonCodeableConcept && this.notDoneReasonCodeableConcept.toJSON(),
      notDoneReasonReference: this.notDoneReasonReference && this.notDoneReasonReference.toJSON(),
