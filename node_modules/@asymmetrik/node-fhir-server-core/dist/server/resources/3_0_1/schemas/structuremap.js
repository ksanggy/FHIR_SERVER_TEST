/**
 * @name exports
 * @summary StructureMap Class
 */
module.exports = class StructureMap {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'structure', {
      ...
      set: value => {
        ...
        let StructureMapStructure = require('./structuremapstructure.js');

        this.__data.structure = Array.isArray(value) ? value.map(v => new StructureMapStructure(v)) : [new StructureMapStructure(value)];
      }
    });
    ...
    Object.defineProperty(this, 'group', {
      ...
      set: value => {
        ...
        let StructureMapGroup = require('./structuremapgroup.js');

        this.__data.group = Array.isArray(value) ? value.map(v => new StructureMapGroup(v)) : [new StructureMapGroup(value)];
      }
