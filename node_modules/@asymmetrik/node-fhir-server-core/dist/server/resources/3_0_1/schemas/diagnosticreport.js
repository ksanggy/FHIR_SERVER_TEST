  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'performer', {
      ...
      set: value => {
        ...
        let DiagnosticReportPerformer = require('./diagnosticreportperformer.js');

        this.__data.performer = Array.isArray(value) ? value.map(v => new DiagnosticReportPerformer(v)) : [new DiagnosticReportPerformer(value)];
      }
    });
    ...
    Object.defineProperty(this, 'image', {
      ...
      set: value => {
        ...
        this.__data.image = Array.isArray(value) ? value.map(v => new DiagnosticReportImage(v)) : [new DiagnosticReportImage(value)];
      }
    });
    ...
    Object.defineProperty(this, 'codedDiagnosis', {
      ...
      set: value => {
        ...
        this.__data.codedDiagnosis = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
