  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'param', {
      ...
      set: value => {
        ...
        this.__data.param = Array.isArray(value) ? value.map(v => new TestScriptSetupActionAssertRulesetRuleParam(v)) : [new TestScriptSetupActionAssertRulesetRuleParam(value)];
      }
