  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'nutrient', {
      ...
      set: value => {
        ...
        this.__data.nutrient = Array.isArray(value) ? value.map(v => new NutritionOrderOralDietNutrient(v)) : [new NutritionOrderOralDietNutrient(value)];
      }
    });
    Object.defineProperty(this, 'texture', {
      ...
      set: value => {
        ...
        this.__data.texture = Array.isArray(value) ? value.map(v => new NutritionOrderOralDietTexture(v)) : [new NutritionOrderOralDietTexture(value)];
      }
