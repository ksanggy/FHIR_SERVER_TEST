  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'designation', {
      ...
      set: value => {
        ...
        this.__data.designation = Array.isArray(value) ? value.map(v => new ExpansionProfileDesignationIncludeDesignation(v)) : [new ExpansionProfileDesignationIncludeDesignation(value)];
      }
