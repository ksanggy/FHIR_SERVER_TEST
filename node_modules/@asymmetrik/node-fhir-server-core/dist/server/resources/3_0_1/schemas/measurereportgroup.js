  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'population', {
      ...
      set: value => {
        ...
        this.__data.population = Array.isArray(value) ? value.map(v => new MeasureReportGroupPopulation(v)) : [new MeasureReportGroupPopulation(value)];
      }
    });
    ...
    Object.defineProperty(this, 'stratifier', {
      ...
      set: value => {
        ...
        this.__data.stratifier = Array.isArray(value) ? value.map(v => new MeasureReportGroupStratifier(v)) : [new MeasureReportGroupStratifier(value)];
      }
