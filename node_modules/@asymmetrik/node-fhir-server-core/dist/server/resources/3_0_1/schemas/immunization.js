  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'practitioner', {
      ...
      set: value => {
        ...
        this.__data.practitioner = Array.isArray(value) ? value.map(v => new ImmunizationPractitioner(v)) : [new ImmunizationPractitioner(value)];
      }
    });
    ...
    Object.defineProperty(this, 'vaccinationProtocol', {
      ...
      set: value => {
        ...
        this.__data.vaccinationProtocol = Array.isArray(value) ? value.map(v => new ImmunizationVaccinationProtocol(v)) : [new ImmunizationVaccinationProtocol(value)];
      }
