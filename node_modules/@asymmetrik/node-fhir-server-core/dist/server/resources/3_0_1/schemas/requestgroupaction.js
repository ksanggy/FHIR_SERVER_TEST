  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'condition', {
      ...
      set: value => {
        ...
        this.__data.condition = Array.isArray(value) ? value.map(v => new RequestGroupActionCondition(v)) : [new RequestGroupActionCondition(value)];
      }
    });
    Object.defineProperty(this, 'relatedAction', {
      ...
      set: value => {
        ...
        this.__data.relatedAction = Array.isArray(value) ? value.map(v => new RequestGroupActionRelatedAction(v)) : [new RequestGroupActionRelatedAction(value)];
      }
    });
