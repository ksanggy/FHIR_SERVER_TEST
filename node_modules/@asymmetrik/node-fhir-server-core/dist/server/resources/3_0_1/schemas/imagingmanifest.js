/**
 * @name exports
 * @summary ImagingManifest Class
 */
module.exports = class ImagingManifest {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'study', {
      ...
      set: value => {
        ...
        let ImagingManifestStudy = require('./imagingmanifeststudy.js');

        this.__data.study = Array.isArray(value) ? value.map(v => new ImagingManifestStudy(v)) : [new ImagingManifestStudy(value)];
      }
