/**
 * @name exports
 * @summary BodySite Class
 */
module.exports = class BodySite {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'qualifier', {
      ...
      set: value => {
        ...
        this.__data.qualifier = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
  ...
  toJSON() {
    return {
      ...
      qualifier: this.qualifier && this.qualifier.map(v => v.toJSON()),
