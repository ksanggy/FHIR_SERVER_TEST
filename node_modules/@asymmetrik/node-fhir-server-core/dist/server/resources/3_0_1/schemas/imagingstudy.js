...
module.exports = class ImagingStudy {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'procedureReference', {
      ...
      set: value => {
        ...
        this.__data.procedureReference = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    ...
    Object.defineProperty(this, 'procedureCode', {
      ...
      set: value => {
        ...
        this.__data.procedureCode = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    ...
    Object.defineProperty(this, 'series', {
      ...
      set: value => {
        ...
        this.__data.series = Array.isArray(value) ? value.map(v => new ImagingStudySeries(v)) : [new ImagingStudySeries(value)];
      }
  ...
  toJSON() {
    return {
      ...
      procedureReference: this.procedureReference && this.procedureReference.map(v => v.toJSON()),
