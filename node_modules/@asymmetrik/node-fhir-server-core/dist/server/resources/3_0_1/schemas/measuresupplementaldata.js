/**
 * @name exports
 * @summary MeasureSupplementalData Class
 */
module.exports = class MeasureSupplementalData {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'usage', {
      ...
      set: value => {
        ...
        this.__data.usage = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
