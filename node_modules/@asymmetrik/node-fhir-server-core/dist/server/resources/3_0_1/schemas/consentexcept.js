  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'actor', {
      ...
      set: value => {
        ...
        this.__data.actor = Array.isArray(value) ? value.map(v => new ConsentExceptActor(v)) : [new ConsentExceptActor(value)];
      }
    ...
    Object.defineProperty(this, 'data', {
      ...
      set: value => {
        ...
        this.__data.data = Array.isArray(value) ? value.map(v => new ConsentExceptData(v)) : [new ConsentExceptData(value)];
      }
