  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'financial', {
      ...
      set: value => {
        ...
        this.__data.financial = Array.isArray(value) ? value.map(v => new EligibilityResponseInsuranceBenefitBalanceFinancial(v)) : [new EligibilityResponseInsuranceBenefitBalanceFinancial(value)];
      }
