/**
 * @name exports
 * @summary ExplanationOfBenefitBenefitBalance Class
 */
module.exports = class ExplanationOfBenefitBenefitBalance {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'financial', {
      ...
      set: value => {
        ...
        let ExplanationOfBenefitBenefitBalanceFinancial = require('./explanationofbenefitbenefitbalancefinancial.js');

        this.__data.financial = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitBenefitBalanceFinancial(v)) : [new ExplanationOfBenefitBenefitBalanceFinancial(value)];
      }
