  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'content', {
      ...
      set: value => {
        ...
        this.__data.content = Array.isArray(value) ? value.map(v => new MedicationPackageContent(v)) : [new MedicationPackageContent(value)];
      }
    });
    Object.defineProperty(this, 'batch', {
      ...
      set: value => {
        ...
        this.__data.batch = Array.isArray(value) ? value.map(v => new MedicationPackageBatch(v)) : [new MedicationPackageBatch(value)];
      }
