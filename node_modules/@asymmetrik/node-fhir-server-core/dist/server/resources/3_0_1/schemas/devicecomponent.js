  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'operationalStatus', {
      ...
      set: value => {
        ...
        this.__data.operationalStatus = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    ...
    Object.defineProperty(this, 'productionSpecification', {
      ...
      set: value => {
        ...
        this.__data.productionSpecification = Array.isArray(value) ? value.map(v => new DeviceComponentProductionSpecification(v)) : [new DeviceComponentProductionSpecification(value)];
      }
    }); // valueSetReference: http://hl7.org/fhir/ValueSet/languages
