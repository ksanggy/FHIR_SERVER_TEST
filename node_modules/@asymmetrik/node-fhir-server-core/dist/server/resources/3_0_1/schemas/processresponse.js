  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'processNote', {
      ...
      set: value => {
        ...
        let ProcessResponseProcessNote = require('./processresponseprocessnote.js');

        this.__data.processNote = Array.isArray(value) ? value.map(v => new ProcessResponseProcessNote(v)) : [new ProcessResponseProcessNote(value)];
      }
    ...
    Object.defineProperty(this, 'error', {
      ...
      set: value => {
        ...
        this.__data.error = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
