  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'benefitBalance', {
      ...
      set: value => {
        ...
        this.__data.benefitBalance = Array.isArray(value) ? value.map(v => new EligibilityResponseInsuranceBenefitBalance(v)) : [new EligibilityResponseInsuranceBenefitBalance(value)];
      }
