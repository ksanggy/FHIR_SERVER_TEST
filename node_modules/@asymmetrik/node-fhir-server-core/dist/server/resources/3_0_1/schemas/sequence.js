  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'variant', {
      ...
      set: value => {
        ...
        this.__data.variant = Array.isArray(value) ? value.map(v => new SequenceVariant(v)) : [new SequenceVariant(value)];
      }
    });
    ...
    Object.defineProperty(this, 'quality', {
      ...
      set: value => {
        ...
        this.__data.quality = Array.isArray(value) ? value.map(v => new SequenceQuality(v)) : [new SequenceQuality(value)];
      }
    });
    ...
    Object.defineProperty(this, 'repository', {
      ...
      set: value => {
        ...
        this.__data.repository = Array.isArray(value) ? value.map(v => new SequenceRepository(v)) : [new SequenceRepository(value)];
      }
    });
