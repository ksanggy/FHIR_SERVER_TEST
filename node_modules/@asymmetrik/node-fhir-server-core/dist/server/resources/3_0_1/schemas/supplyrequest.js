  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'orderedItem', {
      ...
      set: value => {
        ...
        let SupplyRequestOrderedItem = require('./supplyrequestordereditem.js');

        this.__data.orderedItem = new SupplyRequestOrderedItem(value);
      }
    });
    ...
    Object.defineProperty(this, 'requester', {
      ...
      set: value => {
        ...
        let SupplyRequestRequester = require('./supplyrequestrequester.js');

        this.__data.requester = new SupplyRequestRequester(value);
      }
    });
