/**
 * @name exports
 * @summary TestScriptRulesetRule Class
 */
module.exports = class TestScriptRulesetRule {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'param', {
      ...
      set: value => {
        ...
        let TestScriptRulesetRuleParam = require('./testscriptrulesetruleparam.js');

        this.__data.param = Array.isArray(value) ? value.map(v => new TestScriptRulesetRuleParam(v)) : [new TestScriptRulesetRuleParam(value)];
      }
