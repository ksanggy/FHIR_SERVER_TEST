...
module.exports = {
  date: {
    type: 'date',
    fhirtype: 'date',
    xpath: 'RiskAssessment.occurrenceDateTime',
  ...
  probability: {
    type: 'number',
    fhirtype: 'number',
    xpath: 'RiskAssessment.prediction.probabilityDecimal',
  ...
  risk: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'RiskAssessment.prediction.qualitativeRisk',
