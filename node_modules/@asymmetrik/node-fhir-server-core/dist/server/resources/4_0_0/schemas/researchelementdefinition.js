  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'characteristic', {
      ...
      set: value => {
        ...
        this.__data.characteristic = Array.isArray(value) ? value.map(v => new ResearchElementDefinitionCharacteristic(v)) : [new ResearchElementDefinitionCharacteristic(value)];
      }
