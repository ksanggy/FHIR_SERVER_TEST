  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'generalCost', {
      ...
      set: value => {
        ...
        this.__data.generalCost = Array.isArray(value) ? value.map(v => new InsurancePlanPlanGeneralCost(v)) : [new InsurancePlanPlanGeneralCost(value)];
      }
    });
    Object.defineProperty(this, 'specificCost', {
      ...
      set: value => {
        ...
        this.__data.specificCost = Array.isArray(value) ? value.map(v => new InsurancePlanPlanSpecificCost(v)) : [new InsurancePlanPlanSpecificCost(value)];
      }
