  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'filter', {
      ...
      set: value => {
        ...
        this.__data.filter = Array.isArray(value) ? value.map(v => new TerminologyCapabilitiesCodeSystemVersionFilter(v)) : [new TerminologyCapabilitiesCodeSystemVersionFilter(value)];
      }
    });
