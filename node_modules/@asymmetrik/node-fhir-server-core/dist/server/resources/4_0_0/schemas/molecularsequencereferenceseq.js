/**
 * @name exports
 * @summary MolecularSequenceReferenceSeq Class
 */
module.exports = class MolecularSequenceReferenceSeq {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_orientation', {
      ...
      set: value => {
        ...
        this.__data._orientation = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      _orientation: this._orientation && this._orientation.toJSON(),
