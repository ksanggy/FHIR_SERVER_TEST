...
module.exports = class ConceptMap {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_sourceCanonical', {
      enumerable: true,
      get: () => this.__data._sourceCanonical,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._sourceCanonical = new Element(value);
      }
    });
    Object.defineProperty(this, 'sourceCanonical', {
      ...
      set: value => {
        ...
        this.__data.sourceCanonical = value;
      }
    });
    ...
    Object.defineProperty(this, '_targetCanonical', {
      enumerable: true,
      get: () => this.__data._targetCanonical,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._targetCanonical = new Element(value);
      }
    });
    Object.defineProperty(this, 'targetCanonical', {
      ...
      set: value => {
        ...
        this.__data.targetCanonical = value;
      }
    });
    Object.defineProperty(this, 'group', {
      ...
      set: value => {
        ...
        let ConceptMapGroup = require('./conceptmapgroup.js');

        this.__data.group = Array.isArray(value) ? value.map(v => new ConceptMapGroup(v)) : [new ConceptMapGroup(value)];
      }
  ...
  toJSON() {
    return {
      ...
      _sourceCanonical: this._sourceCanonical && this._sourceCanonical.toJSON(),
      sourceCanonical: this.sourceCanonical,
      _targetUri: this._targetUri && this._targetUri.toJSON(),
      targetUri: this.targetUri,
      _targetCanonical: this._targetCanonical && this._targetCanonical.toJSON(),
