...
module.exports = class StructureMapGroupRuleSource {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_logMessage', {
      enumerable: true,
      get: () => this.__data._logMessage,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._logMessage = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      check: this.check,
      _logMessage: this._logMessage && this._logMessage.toJSON(),
