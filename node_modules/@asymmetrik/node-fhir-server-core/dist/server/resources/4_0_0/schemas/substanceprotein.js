/**
 * @name exports
 * @summary SubstanceProtein Class
 */
module.exports = class SubstanceProtein {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_disulfideLinkage', {
      enumerable: true,
      get: () => this.__data._disulfideLinkage,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._disulfideLinkage = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'subunit', {
      ...
      set: value => {
        ...
        let SubstanceProteinSubunit = require('./substanceproteinsubunit.js');
  ...
  toJSON() {
    return {
      ...
      _disulfideLinkage: this._disulfideLinkage && this._disulfideLinkage.toJSON(),
