  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'lensSpecification', {
      ...
      set: value => {
        ...
        let VisionPrescriptionLensSpecification = require('./visionprescriptionlensspecification.js');

        this.__data.lensSpecification = Array.isArray(value) ? value.map(v => new VisionPrescriptionLensSpecification(v)) : [new VisionPrescriptionLensSpecification(value)];
      }
