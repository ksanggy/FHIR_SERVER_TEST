/**
 * @name exports
 * @summary LocationHoursOfOperation Class
 */
module.exports = class LocationHoursOfOperation {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_openingTime', {
      enumerable: true,
      get: () => this.__data._openingTime,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._openingTime = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, '_closingTime', {
      enumerable: true,
      get: () => this.__data._closingTime,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._closingTime = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      allDay: this.allDay,
      _openingTime: this._openingTime && this._openingTime.toJSON(),
      openingTime: this.openingTime,
      _closingTime: this._closingTime && this._closingTime.toJSON(),
