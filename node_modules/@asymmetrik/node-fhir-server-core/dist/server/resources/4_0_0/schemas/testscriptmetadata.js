  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'link', {
      ...
      set: value => {
        ...
        this.__data.link = Array.isArray(value) ? value.map(v => new TestScriptMetadataLink(v)) : [new TestScriptMetadataLink(value)];
      }
    });
    Object.defineProperty(this, 'capability', {
      ...
      set: value => {
        ...
        this.__data.capability = Array.isArray(value) ? value.map(v => new TestScriptMetadataCapability(v)) : [new TestScriptMetadataCapability(value)];
      }
