...
module.exports = class CapabilityStatement {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_imports', {
      ...
      set: value => {
        ...
        this.__data._imports = new Element(value);
      }
    });
    Object.defineProperty(this, 'imports', {
      ...
      set: value => {
        ...
        this.__data.imports = Array.isArray(value) ? value.map(v => v) : [value];
      }
    });
    ...
    Object.defineProperty(this, 'rest', {
      ...
      set: value => {
        ...
        this.__data.rest = Array.isArray(value) ? value.map(v => new CapabilityStatementRest(v)) : [new CapabilityStatementRest(value)];
      }
    });
    Object.defineProperty(this, 'messaging', {
      ...
      set: value => {
        ...
        this.__data.messaging = Array.isArray(value) ? value.map(v => new CapabilityStatementMessaging(v)) : [new CapabilityStatementMessaging(value)];
      }
    });
    Object.defineProperty(this, 'document', {
      ...
      set: value => {
        ...
        this.__data.document = Array.isArray(value) ? value.map(v => new CapabilityStatementDocument(v)) : [new CapabilityStatementDocument(value)];
      }
  ...
  toJSON() {
    return {
      ...
      _imports: this._imports && this._imports.toJSON(),
