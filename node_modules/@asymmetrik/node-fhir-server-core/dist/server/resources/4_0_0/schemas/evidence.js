  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'exposureBackground', {
      ...
      set: value => {
        ...
        this.__data.exposureBackground = new Reference(value);
      }
    });
    Object.defineProperty(this, 'exposureVariant', {
      ...
      set: value => {
        ...
        this.__data.exposureVariant = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
    });
    Object.defineProperty(this, 'outcome', {
      ...
      set: value => {
        ...
        this.__data.outcome = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
