  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'subDetail', {
      ...
      set: value => {
        ...
        this.__data.subDetail = Array.isArray(value) ? value.map(v => new ExplanationOfBenefitAddItemDetailSubDetail(v)) : [new ExplanationOfBenefitAddItemDetailSubDetail(value)];
      }
