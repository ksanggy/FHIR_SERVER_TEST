/**
 * @name exports
 * @summary MedicinalProductIngredient Class
 */
module.exports = class MedicinalProductIngredient {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'specifiedSubstance', {
      ...
      set: value => {
        ...
        let MedicinalProductIngredientSpecifiedSubstance = require('./medicinalproductingredientspecifiedsubstance.js');
    ...
    Object.defineProperty(this, 'substance', {
      ...
      set: value => {
        ...
        let MedicinalProductIngredientSubstance = require('./medicinalproductingredientsubstance.js');
