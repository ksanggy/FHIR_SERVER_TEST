  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'startingMaterial', {
      ...
      set: value => {
        ...
        this.__data.startingMaterial = Array.isArray(value) ? value.map(v => new SubstancePolymerMonomerSetStartingMaterial(v)) : [new SubstancePolymerMonomerSetStartingMaterial(value)];
      }
