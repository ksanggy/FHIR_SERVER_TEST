  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'molecularWeight', {
      ...
      set: value => {
        ...
        this.__data.molecularWeight = Array.isArray(value) ? value.map(v => new SubstanceSpecificationStructureIsotopeMolecularWeight(v)) : [new SubstanceSpecificationStructureIsotopeMolecularWeight(value)];
      }
    });
