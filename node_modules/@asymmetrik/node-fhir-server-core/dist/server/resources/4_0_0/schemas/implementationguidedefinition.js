  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'grouping', {
      ...
      set: value => {
        ...
        this.__data.grouping = Array.isArray(value) ? value.map(v => new ImplementationGuideDefinitionGrouping(v)) : [new ImplementationGuideDefinitionGrouping(value)];
      }
    });
    Object.defineProperty(this, 'resource', {
      ...
      set: value => {
        ...
        this.__data.resource = Array.isArray(value) ? value.map(v => new ImplementationGuideDefinitionResource(v)) : [new ImplementationGuideDefinitionResource(value)];
      }
    });
    ...
    Object.defineProperty(this, 'parameter', {
      ...
      set: value => {
        ...
        this.__data.parameter = Array.isArray(value) ? value.map(v => new ImplementationGuideDefinitionParameter(v)) : [new ImplementationGuideDefinitionParameter(value)];
      }
    });
    Object.defineProperty(this, 'template', {
      ...
      set: value => {
        ...
        this.__data.template = Array.isArray(value) ? value.map(v => new ImplementationGuideDefinitionTemplate(v)) : [new ImplementationGuideDefinitionTemplate(value)];
      }
