/**
 * @name exports
 * @summary MolecularSequenceQuality Class
 */
module.exports = class MolecularSequenceQuality {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'roc', {
      ...
      set: value => {
        ...
        let MolecularSequenceQualityRoc = require('./molecularsequencequalityroc.js');

        this.__data.roc = new MolecularSequenceQualityRoc(value);
      }
