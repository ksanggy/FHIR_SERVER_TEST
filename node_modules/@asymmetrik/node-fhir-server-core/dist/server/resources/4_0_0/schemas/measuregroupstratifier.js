  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'component', {
      ...
      set: value => {
        ...
        let MeasureGroupStratifierComponent = require('./measuregroupstratifiercomponent.js');

        this.__data.component = Array.isArray(value) ? value.map(v => new MeasureGroupStratifierComponent(v)) : [new MeasureGroupStratifierComponent(value)];
      }
