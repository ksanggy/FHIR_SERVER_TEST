  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'substitution', {
      ...
      set: value => {
        ...
        this.__data.substitution = Array.isArray(value) ? value.map(v => new MedicationKnowledgeRegulatorySubstitution(v)) : [new MedicationKnowledgeRegulatorySubstitution(value)];
      }
    });
    Object.defineProperty(this, 'schedule', {
      ...
      set: value => {
        ...
        this.__data.schedule = Array.isArray(value) ? value.map(v => new MedicationKnowledgeRegulatorySchedule(v)) : [new MedicationKnowledgeRegulatorySchedule(value)];
      }
    });
