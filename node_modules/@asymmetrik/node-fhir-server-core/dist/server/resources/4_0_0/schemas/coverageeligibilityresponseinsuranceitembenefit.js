/**
 * @name exports
 * @summary CoverageEligibilityResponseInsuranceItemBenefit Class
 */
module.exports = class CoverageEligibilityResponseInsuranceItemBenefit {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_usedString', {
      enumerable: true,
      get: () => this.__data._usedString,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._usedString = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'resourceType', {
      value: 'CoverageEligibilityResponseInsuranceItemBenefit',
      enumerable: true,
      writable: false
    });
  }
  ...
  toJSON() {
    return {
      ...
      _usedString: this._usedString && this._usedString.toJSON(),
