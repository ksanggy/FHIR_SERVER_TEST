...
module.exports = class OperationDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_affectsState', {
      enumerable: true,
      get: () => this.__data._affectsState,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._affectsState = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'resource', {
      ...
      set: value => {
        ...
        this.__data.resource = Array.isArray(value) ? value.map(v => v) : [value];
      }
    });
    ...
    Object.defineProperty(this, '_inputProfile', {
      enumerable: true,
      get: () => this.__data._inputProfile,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._inputProfile = new Element(value);
      }
    });
    Object.defineProperty(this, 'inputProfile', {
      ...
      set: value => {
        ...
        this.__data.inputProfile = value;
      }
    });
    Object.defineProperty(this, '_outputProfile', {
      enumerable: true,
      get: () => this.__data._outputProfile,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._outputProfile = new Element(value);
      }
    });
    Object.defineProperty(this, 'outputProfile', {
      ...
      set: value => {
        ...
        this.__data.outputProfile = value;
      }
    });
    Object.defineProperty(this, 'parameter', {
      ...
      set: value => {
        ...
        this.__data.parameter = Array.isArray(value) ? value.map(v => new OperationDefinitionParameter(v)) : [new OperationDefinitionParameter(value)];
      }
    });
    Object.defineProperty(this, 'overload', {
      ...
      set: value => {
        ...
        let OperationDefinitionOverload = require('./operationdefinitionoverload.js');

        this.__data.overload = Array.isArray(value) ? value.map(v => new OperationDefinitionOverload(v)) : [new OperationDefinitionOverload(value)];
      }
  ...
  toJSON() {
    return {
      ...
      _affectsState: this._affectsState && this._affectsState.toJSON(),
      ...
      _inputProfile: this._inputProfile && this._inputProfile.toJSON(),
      inputProfile: this.inputProfile,
      _outputProfile: this._outputProfile && this._outputProfile.toJSON(),
