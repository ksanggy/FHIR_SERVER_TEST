  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'variant', {
      ...
      set: value => {
        ...
        this.__data.variant = Array.isArray(value) ? value.map(v => new MolecularSequenceVariant(v)) : [new MolecularSequenceVariant(value)];
      }
    });
    ...
    Object.defineProperty(this, 'quality', {
      ...
      set: value => {
        ...
        this.__data.quality = Array.isArray(value) ? value.map(v => new MolecularSequenceQuality(v)) : [new MolecularSequenceQuality(value)];
      }
    });
    ...
    Object.defineProperty(this, 'repository', {
      ...
      set: value => {
        ...
        this.__data.repository = Array.isArray(value) ? value.map(v => new MolecularSequenceRepository(v)) : [new MolecularSequenceRepository(value)];
      }
    });
    ...
    Object.defineProperty(this, 'structureVariant', {
      ...
      set: value => {
        ...
        this.__data.structureVariant = Array.isArray(value) ? value.map(v => new MolecularSequenceStructureVariant(v)) : [new MolecularSequenceStructureVariant(value)];
      }
