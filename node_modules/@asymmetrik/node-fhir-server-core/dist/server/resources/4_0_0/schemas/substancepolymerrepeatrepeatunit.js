  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'degreeOfPolymerisation', {
      ...
      set: value => {
        ...
        this.__data.degreeOfPolymerisation = Array.isArray(value) ? value.map(v => new SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(v)) : [new SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(value)];
      }
    });
    Object.defineProperty(this, 'structuralRepresentation', {
      ...
      set: value => {
        ...
        this.__data.structuralRepresentation = Array.isArray(value) ? value.map(v => new SubstancePolymerRepeatRepeatUnitStructuralRepresentation(v)) : [new SubstancePolymerRepeatRepeatUnitStructuralRepresentation(value)];
      }
