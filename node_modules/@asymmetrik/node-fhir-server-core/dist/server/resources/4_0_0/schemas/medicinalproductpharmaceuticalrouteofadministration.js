  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'targetSpecies', {
      ...
      set: value => {
        ...
        this.__data.targetSpecies = Array.isArray(value) ? value.map(v => new MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies(v)) : [new MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies(value)];
      }
