/**
 * @name exports
 * @summary EvidenceVariable Class
 */
module.exports = class EvidenceVariable {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'characteristic', {
      ...
      set: value => {
        ...
        let EvidenceVariableCharacteristic = require('./evidencevariablecharacteristic.js');

        this.__data.characteristic = Array.isArray(value) ? value.map(v => new EvidenceVariableCharacteristic(v)) : [new EvidenceVariableCharacteristic(value)];
      }
