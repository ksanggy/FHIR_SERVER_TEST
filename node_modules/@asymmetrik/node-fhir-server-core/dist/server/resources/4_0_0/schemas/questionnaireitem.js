  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'enableWhen', {
      ...
      set: value => {
        ...
        this.__data.enableWhen = Array.isArray(value) ? value.map(v => new QuestionnaireItemEnableWhen(v)) : [new QuestionnaireItemEnableWhen(value)];
      }
    });
    ...
    Object.defineProperty(this, 'answerOption', {
      ...
      set: value => {
        ...
        this.__data.answerOption = Array.isArray(value) ? value.map(v => new QuestionnaireItemAnswerOption(v)) : [new QuestionnaireItemAnswerOption(value)];
      }
    });
    Object.defineProperty(this, 'initial', {
      ...
      set: value => {
        ...
        this.__data.initial = Array.isArray(value) ? value.map(v => new QuestionnaireItemInitial(v)) : [new QuestionnaireItemInitial(value)];
      }
    });
