  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        this.__data.detail = Array.isArray(value) ? value.map(v => new PaymentReconciliationDetail(v)) : [new PaymentReconciliationDetail(value)];
      }
    });
    ...
    Object.defineProperty(this, 'processNote', {
      ...
      set: value => {
        ...
        this.__data.processNote = Array.isArray(value) ? value.map(v => new PaymentReconciliationProcessNote(v)) : [new PaymentReconciliationProcessNote(value)];
      }
