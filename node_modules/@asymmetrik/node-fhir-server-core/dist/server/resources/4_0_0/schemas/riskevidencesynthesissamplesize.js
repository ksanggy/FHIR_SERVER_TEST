/**
 * @name exports
 * @summary RiskEvidenceSynthesisSampleSize Class
 */
module.exports = class RiskEvidenceSynthesisSampleSize {
  constructor(opts) {
  ...
  toJSON() {
    return {
      ...
      _numberOfParticipants: this._numberOfParticipants && this._numberOfParticipants.toJSON(),
