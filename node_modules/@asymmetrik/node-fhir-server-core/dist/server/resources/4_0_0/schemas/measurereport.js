...
module.exports = class MeasureReport {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_measure', {
      enumerable: true,
      get: () => this.__data._measure,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._measure = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'group', {
      ...
      set: value => {
        ...
        this.__data.group = Array.isArray(value) ? value.map(v => new MeasureReportGroup(v)) : [new MeasureReportGroup(value)];
      }
    });
    Object.defineProperty(this, 'evaluatedResource', {
      ...
      set: value => {
        ...
        this.__data.evaluatedResource = Array.isArray(value) ? value.map(v => new Reference(v)) : [new Reference(value)];
      }
  ...
  toJSON() {
    return {
      ...
      type: this.type,
      _measure: this._measure && this._measure.toJSON(),
