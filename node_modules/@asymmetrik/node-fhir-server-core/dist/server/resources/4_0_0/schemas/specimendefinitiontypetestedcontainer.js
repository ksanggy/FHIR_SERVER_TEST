  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'additive', {
      ...
      set: value => {
        ...
        this.__data.additive = Array.isArray(value) ? value.map(v => new SpecimenDefinitionTypeTestedContainerAdditive(v)) : [new SpecimenDefinitionTypeTestedContainerAdditive(value)];
      }
    });
