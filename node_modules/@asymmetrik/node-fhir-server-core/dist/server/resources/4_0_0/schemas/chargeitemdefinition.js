/**
 * @name exports
 * @summary ChargeItemDefinition Class
 */
module.exports = class ChargeItemDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_derivedFromUri', {
      enumerable: true,
      get: () => this.__data._derivedFromUri,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._derivedFromUri = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, '_partOf', {
      enumerable: true,
      get: () => this.__data._partOf,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._partOf = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'propertyGroup', {
      ...
      set: value => {
        ...
        let ChargeItemDefinitionPropertyGroup = require('./chargeitemdefinitionpropertygroup.js');
  ...
  toJSON() {
    return {
      ...
      title: this.title,
      _derivedFromUri: this._derivedFromUri && this._derivedFromUri.toJSON(),
      derivedFromUri: this.derivedFromUri,
      _partOf: this._partOf && this._partOf.toJSON(),
      partOf: this.partOf,
