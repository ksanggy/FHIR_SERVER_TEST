/**
 * @name exports
 * @summary SpecimenDefinition Class
 */
module.exports = class SpecimenDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_timeAspect', {
      enumerable: true,
      get: () => this.__data._timeAspect,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._timeAspect = new Element(value);
      }
    });
    ...
    Object.defineProperty(this, 'typeTested', {
      ...
      set: value => {
        ...
        let SpecimenDefinitionTypeTested = require('./specimendefinitiontypetested.js');
  ...
  toJSON() {
    return {
      ...
      _timeAspect: this._timeAspect && this._timeAspect.toJSON(),
