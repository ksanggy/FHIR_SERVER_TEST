  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'context', {
      ...
      set: value => {
        ...
        this.__data.context = Array.isArray(value) ? value.map(v => new ContractTermAssetContext(v)) : [new ContractTermAssetContext(value)];
      }
    });
    ...
    Object.defineProperty(this, 'answer', {
      ...
      set: value => {
        ...
        this.__data.answer = Array.isArray(value) ? value.map(v => new ContractTermOfferAnswer(v)) : [new ContractTermOfferAnswer(value)];
      }
    });
    ...
    Object.defineProperty(this, 'valuedItem', {
      ...
      set: value => {
        ...
        this.__data.valuedItem = Array.isArray(value) ? value.map(v => new ContractTermAssetValuedItem(v)) : [new ContractTermAssetValuedItem(value)];
      }
