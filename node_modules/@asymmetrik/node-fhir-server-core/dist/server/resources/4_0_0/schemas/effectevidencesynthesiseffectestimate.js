  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'precisionEstimate', {
      ...
      set: value => {
        ...
        this.__data.precisionEstimate = Array.isArray(value) ? value.map(v => new EffectEvidenceSynthesisEffectEstimatePrecisionEstimate(v)) : [new EffectEvidenceSynthesisEffectEstimatePrecisionEstimate(value)];
      }
