...
module.exports = class ResearchElementDefinitionCharacteristic {
  ...
  toJSON() {
    return {
      ...
      _participantEffectiveDescription: this._participantEffectiveDescription && this._participantEffectiveDescription.toJSON(),
      ...
      _participantEffectiveGroupMeasure: this._participantEffectiveGroupMeasure && this._participantEffectiveGroupMeasure.toJSON(),
