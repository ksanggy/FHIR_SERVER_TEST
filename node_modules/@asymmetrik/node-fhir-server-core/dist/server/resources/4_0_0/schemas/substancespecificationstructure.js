  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'isotope', {
      ...
      set: value => {
        ...
        this.__data.isotope = Array.isArray(value) ? value.map(v => new SubstanceSpecificationStructureIsotope(v)) : [new SubstanceSpecificationStructureIsotope(value)];
      }
    });
    ...
    Object.defineProperty(this, 'representation', {
      ...
      set: value => {
        ...
        this.__data.representation = Array.isArray(value) ? value.map(v => new SubstanceSpecificationStructureRepresentation(v)) : [new SubstanceSpecificationStructureRepresentation(value)];
      }
