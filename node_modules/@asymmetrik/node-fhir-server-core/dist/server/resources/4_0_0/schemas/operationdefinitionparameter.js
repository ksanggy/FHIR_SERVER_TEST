  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'referencedFrom', {
      ...
      set: value => {
        ...
        this.__data.referencedFrom = Array.isArray(value) ? value.map(v => new OperationDefinitionParameterReferencedFrom(v)) : [new OperationDefinitionParameterReferencedFrom(value)];
      }
    });
