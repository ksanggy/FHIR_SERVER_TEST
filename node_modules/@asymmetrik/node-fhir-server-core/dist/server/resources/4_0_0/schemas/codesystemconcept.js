  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'designation', {
      ...
      set: value => {
        ...
        this.__data.designation = Array.isArray(value) ? value.map(v => new CodeSystemConceptDesignation(v)) : [new CodeSystemConceptDesignation(value)];
      }
    });
    Object.defineProperty(this, 'property', {
      ...
      set: value => {
        ...
        this.__data.property = Array.isArray(value) ? value.map(v => new CodeSystemConceptProperty(v)) : [new CodeSystemConceptProperty(value)];
      }
    });
