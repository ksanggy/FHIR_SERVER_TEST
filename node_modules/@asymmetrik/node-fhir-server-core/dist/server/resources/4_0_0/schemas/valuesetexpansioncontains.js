  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'designation', {
      ...
      set: value => {
        ...
        this.__data.designation = Array.isArray(value) ? value.map(v => new ValueSetComposeIncludeConceptDesignation(v)) : [new ValueSetComposeIncludeConceptDesignation(value)];
      }
    });
    Object.defineProperty(this, 'contains', {
      ...
      set: value => {
        ...
        this.__data.contains = Array.isArray(value) ? value.map(v => new ValueSetExpansionContains(v)) : [new ValueSetExpansionContains(value)];
      }
