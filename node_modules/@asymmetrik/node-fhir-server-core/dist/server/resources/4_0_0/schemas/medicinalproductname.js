  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'namePart', {
      ...
      set: value => {
        ...
        this.__data.namePart = Array.isArray(value) ? value.map(v => new MedicinalProductNameNamePart(v)) : [new MedicinalProductNameNamePart(value)];
      }
    });
    Object.defineProperty(this, 'countryLanguage', {
      ...
      set: value => {
        ...
        this.__data.countryLanguage = Array.isArray(value) ? value.map(v => new MedicinalProductNameCountryLanguage(v)) : [new MedicinalProductNameCountryLanguage(value)];
      }
