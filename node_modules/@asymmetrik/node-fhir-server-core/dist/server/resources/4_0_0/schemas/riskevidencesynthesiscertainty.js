/**
 * @name exports
 * @summary RiskEvidenceSynthesisCertainty Class
 */
module.exports = class RiskEvidenceSynthesisCertainty {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'certaintySubcomponent', {
      ...
      set: value => {
        ...
        let RiskEvidenceSynthesisCertaintyCertaintySubcomponent = require('./riskevidencesynthesiscertaintycertaintysubcomponent.js');

        this.__data.certaintySubcomponent = Array.isArray(value) ? value.map(v => new RiskEvidenceSynthesisCertaintyCertaintySubcomponent(v)) : [new RiskEvidenceSynthesisCertaintyCertaintySubcomponent(value)];
      }
