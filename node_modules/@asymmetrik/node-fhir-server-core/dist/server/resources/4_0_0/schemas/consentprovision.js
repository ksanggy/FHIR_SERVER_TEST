  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'actor', {
      ...
      set: value => {
        ...
        this.__data.actor = Array.isArray(value) ? value.map(v => new ConsentProvisionActor(v)) : [new ConsentProvisionActor(value)];
      }
    });
    ...
    Object.defineProperty(this, 'data', {
      ...
      set: value => {
        ...
        this.__data.data = Array.isArray(value) ? value.map(v => new ConsentProvisionData(v)) : [new ConsentProvisionData(value)];
      }
    });
