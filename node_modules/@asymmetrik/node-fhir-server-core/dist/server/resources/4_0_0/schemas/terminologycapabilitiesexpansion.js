  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'parameter', {
      ...
      set: value => {
        ...
        this.__data.parameter = Array.isArray(value) ? value.map(v => new TerminologyCapabilitiesExpansionParameter(v)) : [new TerminologyCapabilitiesExpansionParameter(value)];
      }
    });
