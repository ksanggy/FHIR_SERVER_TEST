  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'performer', {
      ...
      set: value => {
        ...
        this.__data.performer = Array.isArray(value) ? value.map(v => new ImagingStudySeriesPerformer(v)) : [new ImagingStudySeriesPerformer(value)];
      }
    });
    Object.defineProperty(this, 'instance', {
      ...
      set: value => {
        ...
        this.__data.instance = Array.isArray(value) ? value.map(v => new ImagingStudySeriesInstance(v)) : [new ImagingStudySeriesInstance(value)];
      }
