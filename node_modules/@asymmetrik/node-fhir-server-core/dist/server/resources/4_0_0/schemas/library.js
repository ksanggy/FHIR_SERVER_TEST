  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'parameter', {
      ...
      set: value => {
        ...
        this.__data.parameter = Array.isArray(value) ? value.map(v => new ParameterDefinition(v)) : [new ParameterDefinition(value)];
      }
    });
    ...
    Object.defineProperty(this, 'content', {
      ...
      set: value => {
        ...
        this.__data.content = Array.isArray(value) ? value.map(v => new Attachment(v)) : [new Attachment(value)];
      }
