  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'dosage', {
      ...
      set: value => {
        ...
        this.__data.dosage = Array.isArray(value) ? value.map(v => new MedicationKnowledgeAdministrationGuidelinesDosage(v)) : [new MedicationKnowledgeAdministrationGuidelinesDosage(value)];
      }
    });
    ...
    Object.defineProperty(this, 'patientCharacteristics', {
      ...
      set: value => {
        ...
        this.__data.patientCharacteristics = Array.isArray(value) ? value.map(v => new MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics(v)) : [new MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics(value)];
      }
