  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'referenceStrength', {
      ...
      set: value => {
        ...
        this.__data.referenceStrength = Array.isArray(value) ? value.map(v => new MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength(v)) : [new MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength(value)];
      }
