  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'securityLabel', {
      ...
      set: value => {
        ...
        this.__data.securityLabel = Array.isArray(value) ? value.map(v => new ContractTermSecurityLabel(v)) : [new ContractTermSecurityLabel(value)];
      }
    });
    ...
    Object.defineProperty(this, 'asset', {
      ...
      set: value => {
        ...
        this.__data.asset = Array.isArray(value) ? value.map(v => new ContractTermAsset(v)) : [new ContractTermAsset(value)];
      }
    });
    Object.defineProperty(this, 'action', {
      ...
      set: value => {
        ...
        this.__data.action = Array.isArray(value) ? value.map(v => new ContractTermAction(v)) : [new ContractTermAction(value)];
      }
    });
