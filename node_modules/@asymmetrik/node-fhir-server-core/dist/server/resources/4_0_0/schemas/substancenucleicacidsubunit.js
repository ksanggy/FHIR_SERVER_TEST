  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'linkage', {
      ...
      set: value => {
        ...
        this.__data.linkage = Array.isArray(value) ? value.map(v => new SubstanceNucleicAcidSubunitLinkage(v)) : [new SubstanceNucleicAcidSubunitLinkage(value)];
      }
    });
    Object.defineProperty(this, 'sugar', {
      ...
      set: value => {
        ...
        this.__data.sugar = Array.isArray(value) ? value.map(v => new SubstanceNucleicAcidSubunitSugar(v)) : [new SubstanceNucleicAcidSubunitSugar(value)];
      }
