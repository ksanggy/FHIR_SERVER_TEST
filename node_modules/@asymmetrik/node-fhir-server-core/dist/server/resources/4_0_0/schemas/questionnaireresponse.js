...
module.exports = class QuestionnaireResponse {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_questionnaire', {
      enumerable: true,
      get: () => this.__data._questionnaire,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._questionnaire = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      _questionnaire: this._questionnaire && this._questionnaire.toJSON(),
