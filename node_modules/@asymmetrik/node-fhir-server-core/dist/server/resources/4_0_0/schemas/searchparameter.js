...
module.exports = class SearchParameter {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_multipleOr', {
      enumerable: true,
      get: () => this.__data._multipleOr,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._multipleOr = new Element(value);
      }
    });
    Object.defineProperty(this, 'multipleOr', {
      ...
      set: value => {
        ...
        this.__data.multipleOr = value;
      }
    });
    Object.defineProperty(this, '_multipleAnd', {
      enumerable: true,
      get: () => this.__data._multipleAnd,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._multipleAnd = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      target: this.target,
      _multipleOr: this._multipleOr && this._multipleOr.toJSON(),
      multipleOr: this.multipleOr,
      _multipleAnd: this._multipleAnd && this._multipleAnd.toJSON(),
