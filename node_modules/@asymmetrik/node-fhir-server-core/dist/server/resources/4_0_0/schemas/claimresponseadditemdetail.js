  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'adjudication', {
      ...
      set: value => {
        ...
        this.__data.adjudication = Array.isArray(value) ? value.map(v => new ClaimResponseItemAdjudication(v)) : [new ClaimResponseItemAdjudication(value)];
      }
    });
    Object.defineProperty(this, 'subDetail', {
      ...
      set: value => {
        ...
        let ClaimResponseAddItemDetailSubDetail = require('./claimresponseadditemdetailsubdetail.js');

        this.__data.subDetail = Array.isArray(value) ? value.map(v => new ClaimResponseAddItemDetailSubDetail(v)) : [new ClaimResponseAddItemDetailSubDetail(value)];
      }
