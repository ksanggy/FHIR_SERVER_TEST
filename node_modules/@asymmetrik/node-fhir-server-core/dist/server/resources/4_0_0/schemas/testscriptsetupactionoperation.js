  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'requestHeader', {
      ...
      set: value => {
        ...
        this.__data.requestHeader = Array.isArray(value) ? value.map(v => new TestScriptSetupActionOperationRequestHeader(v)) : [new TestScriptSetupActionOperationRequestHeader(value)];
      }
    });
