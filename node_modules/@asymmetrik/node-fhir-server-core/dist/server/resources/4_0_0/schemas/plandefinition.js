/**
 * @name exports
 * @summary PlanDefinition Class
 */
module.exports = class PlanDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'goal', {
      ...
      set: value => {
        ...
        let PlanDefinitionGoal = require('./plandefinitiongoal.js');

        this.__data.goal = Array.isArray(value) ? value.map(v => new PlanDefinitionGoal(v)) : [new PlanDefinitionGoal(value)];
      }
    });
