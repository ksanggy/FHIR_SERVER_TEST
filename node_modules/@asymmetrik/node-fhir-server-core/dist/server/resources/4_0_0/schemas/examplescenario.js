/**
 * @name exports
 * @summary ExampleScenario Class
 */
module.exports = class ExampleScenario {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'actor', {
      ...
      set: value => {
        ...
        let ExampleScenarioActor = require('./examplescenarioactor.js');

        this.__data.actor = Array.isArray(value) ? value.map(v => new ExampleScenarioActor(v)) : [new ExampleScenarioActor(value)];
      }
    });
    Object.defineProperty(this, 'instance', {
      ...
      set: value => {
        ...
        let ExampleScenarioInstance = require('./examplescenarioinstance.js');

        this.__data.instance = Array.isArray(value) ? value.map(v => new ExampleScenarioInstance(v)) : [new ExampleScenarioInstance(value)];
      }
    });
    ...
    Object.defineProperty(this, '_workflow', {
      ...
      set: value => {
        ...
        this.__data._workflow = new Element(value);
      }
    });
    Object.defineProperty(this, 'workflow', {
      ...
      set: value => {
        ...
        this.__data.workflow = Array.isArray(value) ? value.map(v => v) : [value];
      }
  ...
  toJSON() {
    return {
      ...
      _workflow: this._workflow && this._workflow.toJSON(),
