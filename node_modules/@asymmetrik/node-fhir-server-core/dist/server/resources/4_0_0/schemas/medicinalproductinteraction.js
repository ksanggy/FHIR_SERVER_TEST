/**
 * @name exports
 * @summary MedicinalProductInteraction Class
 */
module.exports = class MedicinalProductInteraction {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'interactant', {
      ...
      set: value => {
        ...
        let MedicinalProductInteractionInteractant = require('./medicinalproductinteractioninteractant.js');
