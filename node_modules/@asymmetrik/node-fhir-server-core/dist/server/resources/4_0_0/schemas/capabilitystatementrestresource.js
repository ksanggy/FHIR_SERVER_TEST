  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'interaction', {
      ...
      set: value => {
        ...
        this.__data.interaction = Array.isArray(value) ? value.map(v => new CapabilityStatementRestResourceInteraction(v)) : [new CapabilityStatementRestResourceInteraction(value)];
      }
    });
