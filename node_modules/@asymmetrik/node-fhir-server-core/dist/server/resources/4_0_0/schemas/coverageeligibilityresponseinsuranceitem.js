  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'benefit', {
      ...
      set: value => {
        ...
        this.__data.benefit = Array.isArray(value) ? value.map(v => new CoverageEligibilityResponseInsuranceItemBenefit(v)) : [new CoverageEligibilityResponseInsuranceItemBenefit(value)];
      }
    });
