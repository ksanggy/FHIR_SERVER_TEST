  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'priceComponent', {
      ...
      set: value => {
        ...
        this.__data.priceComponent = Array.isArray(value) ? value.map(v => new ChargeItemDefinitionPropertyGroupPriceComponent(v)) : [new ChargeItemDefinitionPropertyGroupPriceComponent(value)];
      }
