...
module.exports = class Provenance {
  constructor(opts) {
    ...
    Object.defineProperty(this, '_occurredDateTime', {
      enumerable: true,
      get: () => this.__data._occurredDateTime,
      set: value => {
        if (value === undefined || value === null) {
          return;
        }
        ...
        this.__data._occurredDateTime = new Element(value);
      }
    });
  ...
  toJSON() {
    return {
      ...
      _occurredDateTime: this._occurredDateTime && this._occurredDateTime.toJSON(),
