/**
 * @name exports
 * @summary BodyStructure Class
 */
module.exports = class BodyStructure {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'morphology', {
      ...
      set: value => {
        ...
        this.__data.morphology = new CodeableConcept(value);
      }
    });
    ...
    Object.defineProperty(this, 'locationQualifier', {
      ...
      set: value => {
        ...
        this.__data.locationQualifier = Array.isArray(value) ? value.map(v => new CodeableConcept(v)) : [new CodeableConcept(value)];
      }
    });
