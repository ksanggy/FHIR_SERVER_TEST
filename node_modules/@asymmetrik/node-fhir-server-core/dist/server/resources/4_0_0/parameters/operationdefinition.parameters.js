...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'OperationDefinition.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'OperationDefinition.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'OperationDefinition.useContext.code',
  ...
  title: {
    type: 'string',
    fhirtype: 'string',
    xpath: 'OperationDefinition.title',
  ...
  'input-profile': {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'OperationDefinition.inputProfile',
  ...
  'output-profile': {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'OperationDefinition.outputProfile',
