...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ValueSet.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'ValueSet.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ValueSet.useContext.code',
  ...
  code: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ValueSet.expansion.contains.code',
