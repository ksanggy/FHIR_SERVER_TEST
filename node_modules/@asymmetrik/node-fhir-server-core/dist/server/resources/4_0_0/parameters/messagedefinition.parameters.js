...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'MessageDefinition.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'MessageDefinition.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'MessageDefinition.useContext.code',
  ...
  event: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'MessageDefinition.eventCoding',
  ...
  parent: {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'MessageDefinition.parent',
