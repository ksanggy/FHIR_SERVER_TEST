...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ConceptMap.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'ConceptMap.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ConceptMap.useContext.code',
  ...
  source: {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'ConceptMap.sourceCanonical',
