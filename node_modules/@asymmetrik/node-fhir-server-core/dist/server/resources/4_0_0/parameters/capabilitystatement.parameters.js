...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'CapabilityStatement.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'CapabilityStatement.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'CapabilityStatement.useContext.code',
  ...
  'supported-profile': {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'CapabilityStatement.rest.resource.supportedProfile',
