...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'CompartmentDefinition.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'CompartmentDefinition.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'CompartmentDefinition.useContext.code',
  ...
  version: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'CompartmentDefinition.version',
