...
module.exports = {
  context: {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ImplementationGuide.useContext.valueCodeableConcept',
  ...
  'context-quantity': {
    type: 'quantity',
    fhirtype: 'quantity',
    xpath: 'ImplementationGuide.useContext.valueQuantity',
  ...
  'context-type': {
    type: 'token',
    fhirtype: 'token',
    xpath: 'ImplementationGuide.useContext.code',
  ...
  title: {
    type: 'string',
    fhirtype: 'string',
    xpath: 'ImplementationGuide.title',
  ...
  global: {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'ImplementationGuide.global.profile',
  ...
  resource: {
    type: 'reference',
    fhirtype: 'reference',
    xpath: 'ImplementationGuide.definition.resource.reference',
