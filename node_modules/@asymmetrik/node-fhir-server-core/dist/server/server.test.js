...
const winston = require('winston'); // npm express
...
describe('Server Class', () => {
  ...
  test('Method: configureMiddleware', () => {
    ...
    let use = jest.spyOn(server.app, 'use'); // Setup our middleware
  ...
  test('Method: configureHelmet', () => {
    let use = jest.spyOn(server.app, 'use'); // Setup logstream
  ...
  test('Method: listen', () => {
    ...
    let callback = jest.fn(); // Start listening on a port and pass the callback through
